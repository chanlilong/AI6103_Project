...
if __name__=="__main__":
    ...
    writer = SummaryWriter(logdir = f"./tensorboard_logs/Favor_Attn")

    FavorAttention = partial(LinearAttention,query_dimensions=256//8,feature_map=Favor)
    model = Protein_Classifier(layer=FavorAttention,dim=256,n_layers=6,n_heads=8,dim_feedfwd=512,causal=False)
    model.cuda()
    ...
    for e in tqdm(range(EPOCHS)):
        ...
        torch.save(model_dict,"./weights/favor_model.pth")