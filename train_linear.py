...
from classifier import Protein_Classifier
...
if __name__=="__main__":
    ...
    writer = SummaryWriter(logdir = f"./tensorboard_logs/Linear_Attn")


    model = Protein_Classifier(layer=LinearAttention,dim=256,n_layers=6,n_heads=8,dim_feedfwd=512,causal=False)
    model.cuda()
    ...
    for e in tqdm(range(EPOCHS)):
        ...
        torch.save(model_dict,"./weights/linear_model.pth")